...
class ReservationModel:
	...
	def create_reservation( 
        ...
        """ Insert a enw reservation into the database."""
	...
	@staticmethod
	def get_reservation_by_id(reservation_id) -> Optional[Dict[str, Any]]:
		...
		try:
			...
			print(f"[Error] Failed to fetching reservation by ID: {e} ")
			return None
		finally:
			cursor.close()
			conn.close()
	...
	@staticmethod
	def get_reservation_by_guest(guest_id: int) -> List[str, Any]]:
		...
		try:
			...
			print(f"[Error] Failed to fetch reservation reservations by guest:{e}") guest reservations: {e}")
			return []
		finally:
			cursor.close()
			conn.close()
