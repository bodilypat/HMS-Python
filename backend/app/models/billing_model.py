...
class BillingModel:
	...
	@staticmethod
	def create_billing(reservation_id, service_charge=0.00, discount=0.00, total_amount=0.00, payment_status='Unpaid'):
	...
	@staticmethod
	def update_billing(billing_id, service_charge=None, discount=None, total_amount=None, payment_status=None):
